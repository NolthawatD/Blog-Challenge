...
export default function ContentBlog({ blogs, handleToggleRemove, handleToggleEdit, fetchNextPage, hasNextPage, isLoading, error }: ContentBlogProps) {
	...
	return (
		<InfiniteScroll dataLength={blogs ? blogs.length : 0} next={fetchNextPage} hasMore={hasNextPage} loader={<div>Loading...</div>}>
			<div>
				{/* Content */}
									...
									<div className="flex flex-row flex-wrap py-4">
										<aside className="w-full px-2 ">
											<div className="sticky top-0 p-4 w-fullrounded-lg">
												...
												<h2
													className="text-3xl	font-medium	mt-3 hover:cursor-pointer"

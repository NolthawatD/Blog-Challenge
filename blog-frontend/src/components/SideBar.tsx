			...
			<div className="p-6 w-1/2 h-screen z-0 fixed top-0 -left-96 lg:left-0 lg:w-60  peer-focus:left-0 peer:transition ease-out delay-150 duration-200">
				<div className="flex flex-col justify-start item-center">
					<div className=" mt-20 pb-4 ">
						<div className="flex mb-2 justify-start items-center gap-4 pl-5 p-2 cursor-pointer m-auto" onClick={() => router.push('/blog')}>
						...
						<div className="flex mb-2 justify-start items-center gap-4 pl-5 p-2 cursor-pointer m-auto group-hover:text-white" onClick={() => router.push('/our-blog')}>

...
// const SignIn = () => {
// 	return (
// 		<div className="flex flex-col lg:flex-row h-screen bg-green-500">
// 			{/* Right side (a Board) */}
// 			<div className="flex-1 bg-green-300 flex items-center justify-center p-4 lg:rounded-tl-3xl lg:rounded-bl-3xl">
...
// 			{/* Left side (SignInBox) */}
// 			<div className="flex-1 bg-dark-green flex items-center justify-center p-4 order-last lg:order-first">
// 				<SignInBox />
// 			</div>
// 		</div>
// 	);
